            ...
            <div class="item" style="margin-bottom: 20px;">
              ...
              <div class="item-info">
                <div class="item-text">
                  ...
                  <a href="?page=confirm&id=<?php echo $product['id']; ?>" class="btn btn-primary w-100 mb-1 border-0">ซื้อสินค้า</a>
                  <a href="?page=confirm&id=<?php echo $product['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-gift"></i> ส่งของขวัญ</a>
                </div>
              </div>
            </div>
              </div> 
