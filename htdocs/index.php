                        ...
                        <div class="dropdown-menu border-0 shadow animate slideIn" aria-labelledby="navbarDropdown">
                            ...
                            <span class="d-block" tabindex="0" data-toggle="tooltip" data-placement="left" title="Under Development!" data-container=".sb-navbar">
                                ...
                                <span class="d-block" tabindex="0">
                                    <a class="dropdown-item <?php if($_GET['page'] == "angpao"){echo 'active';}else{} ?>" href="?page=angpao">อังเปา (ซองแดง)</a>
                                </span>
                            </span>
                        </div>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-8">
                   <?php
                    ...
                    }elseif($_GET['page'] == "angpao"){
                        include_once __DIR__.'/_page/angpao.php';
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow mb-4 d-none d-lg-block">
                        <div class="card-body">
                            ...
                            <?php }else{ ?>
                            <a>
                                <i class="fal fa-user fa-fw"></i> <span>เข้าสู่ระบบ</span>
                            </a>
                            <hr>
...
<div class="card-body">
    <h5 class="m-0"><i class="fa fa-signal"></i>  สถานะเซิฟเวอร์</h5>
    <hr>
...
<tr>
<td width="100">
<img src="<?php echo $setting['icon']; ?>" width="50" height="50">
</td>
<td style="color: #fff;">
 Copyright © | <a target="_blank" class="foot_hover"  href="backend">จัดการระบบ</a><br>
<a target="_blank" class="foot_hover
</td>
</tr>
</tbody>
</table>
