<?php
		if(isset($_POST['settings_web_submit']))
		{
			...
			{
				$msg = 'แก้ไขการตั้งค่า Download ไม่สำเร็จ';
				$alert = 'error';
...
?>
			...
			<form name="settings_web_submit" method="POST">
				<div class="row">
					...
					<hr class="is-divider">
                                        <div class="text-center" width="24" data-toggle="collapse" href="#collapseDetail-112" role="button" aria-expanded="false" aria-controls="collapseDetail-112"><i class="fas fa-arrow-circle-down"></i> ตั้งค่าขั้นสูง</div>
